 ...
 * 忽略列表判断
 */
export declare function matchIgnoresAndRule(url: string, match: string, type: IMatchRedirectContent['filter_type'], ignores: IMatchRedirectContent['ignores']): boolean;
/**格式化URL 返回 string */
