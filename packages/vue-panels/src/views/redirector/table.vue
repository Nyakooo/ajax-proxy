<template>
  <div class="request-container">
    ...
    <el-table :data="tableData" stripe style="margin-top: 20px">
      ...
      <el-table-column prop="domain" :label="$t('domain')" show-overflow-tooltip />
      <el-table-column prop="redirect_url" :label="$t('redirect')" show-overflow-tooltip />
...
import { useRedirects } from '@/infrastructure/storage'
