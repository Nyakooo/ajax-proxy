import { V3_BACKUP_DISABLED_ORIGINS_VERSION, V3_BACKUP_EXACT_MATCH_VERSION, V3_BACKUP_LEGACY_VERSION, V3_BACKUP_PREVIOUS_VERSION, V3_BACKUP_REDIRECT_EXCLUSIONS_VERSION, V3_BACKUP_REDIRECT_FUNCTION_VERSION, V3_BACKUP_VERSION } from './backupVersion';
import type { V3ResponseFunctionResult, V3Rule, V3Tag } from './rules';
export declare const V3_BACKUP_FORMAT: "ajax-proxy-backup";
export { V3_BACKUP_DISABLED_ORIGINS_VERSION, V3_BACKUP_EXACT_MATCH_VERSION, V3_BACKUP_LEGACY_VERSION, V3_BACKUP_PREVIOUS_VERSION, V3_BACKUP_REDIRECT_EXCLUSIONS_VERSION, V3_BACKUP_REDIRECT_FUNCTION_VERSION, V3_BACKUP_VERSION, };
