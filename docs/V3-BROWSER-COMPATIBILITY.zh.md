...
| JavaScript 语法 / Web API                                                    | Chrome 141+（本次最低支持版本）     | Edge 140+（本次最低支持版本） | 按功能确定                    | 能力检测或不启用非核心功能        | Vue 面板 Babel 目标设为 Chrome 141+ / Edge 140+；TypeScript / Vite 使用 ES2022。Chrome 141 当前构建 smoke 通过；Edge 140 等待 CI                                                                            |
| Fetch / Request / Response、XHR、URL、Headers、TextEncoder                   | Chrome 141+（本次最低支持版本）     | Edge 140+（本次最低支持版本） | 是                            | 不适用                            | Chrome 141 和 Chrome / Edge Stable 网页运行时 smoke；Chrome 141 与 Stable 扩展 Fetch / XHR 集成 smoke。Edge 140 扩展矩阵等待 CI                                                                             |
